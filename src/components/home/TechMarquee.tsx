...
const repeated = (slugs: Slug[], times = 2) =>
  Array.from({ length: times }).flatMap(() => slugs);
...
function MarqueeRow({
  ...
  return (
    <div className="tech-marquee__viewport">
      <div
        className={`tech-marquee__track tech-marquee__track--${direction}`}
        aria-hidden="true"
      >
...
export function TechMarquee() {
  return (
    <div
      ...
      aria-label="Marketing and growth tools GeneRays works with"
    >
