    ...
    <>
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 px-5 py-20 md:grid-cols-[1.05fr_0.95fr] md:items-center md:py-24">
          <div>
            <Link to="/services" className="eyebrow inline-flex items-center gap-2">Services / {service.letter}</Link>
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-6xl px-5 py-20">
          ...
          <div className="mt-16 rounded-sm border border-primary/20 bg-primary p-10 text-primary-foreground">
            ...
            <Link to="/contact" className="mt-7 inline-flex items-center gap-2 rounded-sm bg-background px-6 py-3.5 text-sm font-semibold text-primary">Schedule a Free Brand Consultation <ArrowRight className="h-4 w-4" /></Link>
          </div>
        </div>
      </section>
    </>
